            ...
            <form onSubmit={submitForm}>
              <div className="grid gap-y-4">
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      id="email"
                      name="email"
                      className="py-3 px-4 block w-full border border-grey-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 focus:outline-none disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                      required
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      id="password"
                      name="password"
                      className="py-3 px-4 block w-full border border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 focus:outline-none disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                      required
                ...
                <div className="flex items-center">
                  ...
                  <div className="ms-3">
                    <label htmlFor="remember-me" className="text-sm dark:text-white">I accept the terms and conditions</label>
                  </div>
                </div>
